...
<script setup lang="ts">
    ...
    onMounted(async () => {
        try {
            const response = await axios.get('prisma:2083/priceCarsBrand/1');
    ...
    const getTitle = async (event) => {
        ...
        try {
            const response = await axios.get(`prisma:2083/priceCarsBrand/1/${dataBrand.value}`);
    ...
    const getYear = async (event) => {
        ...
        try {
            const response = await axios.get(`prisma:2083/priceCarsBrand/1/${dataBrand.value}/${dataTitle.value}`);
    ...
    const getGen = async (event) => {
        ...
        try {
            if(dataGen.value === '0') {
                ...
                const response = await axios.get(`prisma:2083/priceCarsBrand/1/${dataBrand.value}/${dataTitle.value}/${dataGen.value}`);
    ...
    const getPrice = async (event) => {
        ...
        try {
            const response = await axios.get(`prisma:2083/priceCarsBrand/1/${dataBrand.value}/${dataTitle.value}/${dataGen.value}/${dataPrice.value}`);
