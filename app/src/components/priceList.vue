...
<script setup lang="ts">
    ...
    onMounted(async () => {
        try {
            const response = await axios.get('http://localhost:3000/priceCarsBrand/1');
    ...
    const getGen = async (event) => {
        ...
        try {
            if(dataGen.value === '0') {
                ...
                const response = await axios.get(`http://localhost:3000/priceCarsBrand/1/${dataBrand.value}/${dataTitle.value}/${dataGen.value}`);
    ...
    const getPrice = async (event) => {
        ...
        try {
            const response = await axios.get(`http://localhost:3000/priceCarsBrand/1/${dataBrand.value}/${dataTitle.value}/${dataGen.value}/${dataPrice.value}`);
